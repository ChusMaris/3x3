    ...
    <div className="flex flex-col h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <header className="bg-[#1a1a2e] text-white py-4 px-8 border-b-4 border-[#e94560] flex items-center justify-between shadow-xl shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black italic tracking-tighter uppercase leading-none">BRAFA 3x3 <span className="text-[#e94560]">OPEN</span></h1>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Escuela Deportiva BRAFA · Gestión de Torneos</p>
          </div>
        </div>
                  ...
                  <section key={cat} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    {catData.groups ? (
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {Object.entries(catData.groups).map(([letter, groupTeams]) => (
